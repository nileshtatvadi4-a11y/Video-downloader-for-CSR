...
def get_cookie_value():
    """
    Environment-variable lookup is case-insensitive.
...
def download_worker(
    ...
    try:
        ...
        if mode == "audio":
            ...
            selected_acodec = selected.get(
                "acodec"
            )

            if (
                selected_acodec is None
        ...
        # ====================================================
            ...
            # If video has no audio, find compatible
            # audio and merge it.
            if (
        ...
        update_job(
            ...
            stage="FINALIZING",
            message=(
                "Finding the completed output file."
            ),
        )
